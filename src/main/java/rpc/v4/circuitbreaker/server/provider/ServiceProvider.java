package rpc.v4.circuitbreaker.server.provider;

import lombok.Getter;
import rpc.v4.circuitbreaker.server.ratelimit.provider.RateLimitProvider;
import rpc.v4.circuitbreaker.server.register.ServiceRegister;
import rpc.v4.circuitbreaker.server.register.impl.ZKServiceRegister;

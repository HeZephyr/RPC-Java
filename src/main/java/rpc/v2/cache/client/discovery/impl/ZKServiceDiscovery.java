package rpc.v2.cache.client.discovery.impl;
...
import rpc.v2.cache.client.cache.ServiceCache;
import rpc.v2.cache.client.discovery.ServiceDiscovery;
import rpc.v2.cache.client.discovery.watcher.ZKWatcher;
...
public class ZKServiceDiscovery implements ServiceDiscovery {
    ...
    public InetSocketAddress discoveryService(String serviceName) {
        try {
            ...
            String serviceAddress = serviceList.get(index);
